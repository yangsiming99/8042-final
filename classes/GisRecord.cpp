...
void GISRecord::setLat_Dec_prim(double lat_dec)
{
...
void GISRecord::setLong_Dec_prim(double long_dec)
{
...
void GISRecord::setLat_Dec_src(double lat_dec)
{
...
void GISRecord::setLong_Dec_src(double long_dec)
{
...
void GISRecord::setElevation_m(int m)
{
	this.elevation_m = m;
}
...
void GISRecord::setElevation_ft(int ft)
{
